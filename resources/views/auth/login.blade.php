...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="row shadow rounded overflow-hidden" style="max-width: 900px; width: 100%;">
        ...
        <div class="col-md-6 p-0">
            <img src="{{ asset('images/troupesync.png') }}" 
                 alt="TroupeSync" 
        ...
        <div class="col-md-6 bg-white p-4 d-flex flex-column justify-content-center">
            ...
            <div class="d-flex justify-content-center mb-4">
                <button type="button" class="btn btn-warning me-2 fw-bold px-4">ADMIN</button>
                <button type="button" class="btn btn-outline-dark fw-bold px-4">PERFORMER</button>
            </div>

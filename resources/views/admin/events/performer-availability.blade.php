                        ...
                        <tr>
                            ...
                            <td style="padding:8px; border:1px solid #ddd;"> 
                                ...
                                <button class="btn-availability" 
                                    ...
                                    data-user="{{ $performer->id }}" 
                                    data-status="undo" 
                                    style="{{ $performer->pivot->status=='undo'?' background-color:#e74c3c; color:white; ':' color:#000000; ' }} padding:4px 10px; border:none; border-radius:4px;">
                                    UNDO 
                                </button>
                            </td>
                        </tr>

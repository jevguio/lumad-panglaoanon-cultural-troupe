...
<div style="padding: 20px; max-width: 900px; margin: auto;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        ...
        <button id="openAddModal" style="background: black; color: white; padding: 6px 12px; border: none; border-radius: 4px; cursor: pointer;">
            ➕ Add Account
        </button>
    </div>
            ...
            @foreach($users as $index => $user)
                <tr style="background-color: rgb(228, 228, 228);">
                    ...
                    <td style="padding: 8px; border: 1px solid #ddd;">
                        ...
                        <button disabled style="background: orange; color: white; border: none; padding: 4px 8px; border-radius: 3px;">
                            VIEW
                        </button>
                    </td>
                </tr>
